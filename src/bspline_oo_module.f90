...
!  This is a wrapper for [[initialize_1d_auto_knots]].
    ...
    function bspline_1d_constructor_auto_knots(x,fcn,kx,extrap) result(me)
...
!  This is a wrapper for [[initialize_1d_specify_knots]].
    ...
    function bspline_1d_constructor_specify_knots(x,fcn,kx,tx,extrap) result(me)
...
!  This is a wrapper for [[db1ink]].
    ...
    subroutine initialize_1d_auto_knots(me,x,fcn,kx,iflag,extrap)
...
!  This is a wrapper for [[db1ink]].
    ...
    subroutine initialize_1d_specify_knots(me,x,fcn,kx,tx,iflag,extrap)
